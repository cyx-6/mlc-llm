...
class LLMChat {
 ...
 public:
   ...
   */
  void Reload(tvm::runtime::Module executable, tvm::runtime::Module lora_executable,
              String model_path, String app_config_json = "") {
    ...
    lora_vm_->GetFunction("vm_initialization")(
  ...
  void ApplyLora(std::string torch_name, int param_idx, Array<tvm::Integer> quantized_param_indices,
                 NDArray lora_a, NDArray lora_b) {
